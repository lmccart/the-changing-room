...
const screenParams = {
  0: { id: 0, name: 'LEFT', width: 883, height: 520, display: 'left projector'},
  1: { id: 1, name: 'CENTER', width: 883, height: 520, display: 'center projector' },
  2: { id: 2, name: 'RIGHT', width: 883, height: 520, display: 'right projector' },
...
function displayMeditationPhrase(opts) {
  ...
  let sizeClass = text.length > 60 ? 'smaller_meditation_text' : '';
  $('#meditation_text')
